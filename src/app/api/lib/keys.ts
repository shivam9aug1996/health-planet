...
export const dbUrl = `mongodb+srv://shivam9aug1996:${dbPassword}@health-planet-cluster.ddb5on8.mongodb.net/?retryWrites=true&w=majority&appName=health-planet-cluster`;
